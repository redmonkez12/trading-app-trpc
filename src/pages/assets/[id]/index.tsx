...
export default function Assets() {
  ...
  return (
    <div className={"p-4"}>
      <h1 className={"text-5xl font-bold text-white mb-8 text-center"}>Assets</h1>
      ...
      <ul className={"list-none list-inside flex flex-col gap-5"}>
        {assets.map((asset) => {
          ...
          return (
            <li key={asset.id} className={"flex gap-3 items-center border-solid border p-4 bg-gray-800 border-gray-700 text-white"}>
